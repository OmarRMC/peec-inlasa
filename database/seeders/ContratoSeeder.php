...
class ContratoSeeder extends Seeder
{
    public function run()
    {
        ...
        $detalles = [
            [
                'titulo' => '',
                'descripcion' => 'El Instituto Nacional de Laboratorios de Salud "Dr Néstor Morales Villazón" INLASA, con Número de Identificación Tributaria N° 1001419025 y domicilio establecido en el pasaje Rafael Zubieta N°1889 (al Lado del Hospital del Niño) de la zona de Miraflores de la ciudad de La Paz, legalmente representado por su Directora General Ejecutiva Dra. Patricia Carla Vacaflor Torrico, titular de la Cédula de Identidad N.º 1881125 LP, en mérito a la Resolución Ministerial N° 0017 del 21 de noviembre 2025, quien en adelante y para efectos del presente contrato se denominará INLASA
Por otro lado, el Laboratorio **{{ laboratorioNombreLab }}** participante del Programa de Evaluación Externa de la Calidad - INLASA {{ gestionInscripcion }}, con domicilio establecido en **{{ laboratorioZonaLab }}**, **{{ laboratorioDireccionLab }}** de la ciudad/departamento de **{{ departamento_raw }}**, legalmente representado por **{{ laboratorioReprelegLab }}**, titular de la cedula identidad N.º **{{ laboratorioCiReprelegLab }}**, que para fines de ejecución y seguimiento del presente contrato se denominara "PARTICIPANTE"',
                'posicion' => 1,
                'estado' => 1
            ],
            [
