                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p>Para completar el proceso, por favor haz clic en
                                                                        el siguiente botón para verificar tu correo
                                                                        electrónico:</p>

                                                                    <p style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:26px;font-style:normal;font-weight:bold;line-height:31.2px;color:#0b5394">
                                                                        <a href="{{ $url_verificacion }}"
                                                                            class="btn">Verificar Correo</a>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
