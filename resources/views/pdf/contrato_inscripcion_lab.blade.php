    ...
    <div class="contenido">
        ...
        <div class="clause" style="margin: 0">
            <p>
                ...
                Identificación Tributaria N° 1001419025 y domicilio establecido en la calle Rafael Zubieta N°1889 (al
                Lado
                del Hospital
                del Niño) de la zona de Miraflores de la ciudad de La Paz, legalmente representado por su Directora
                General
                Ejecutiva
        ...
        <div class="section">
            ...
            <p class="clause">
                ...
                responsabilidad
                Técnica de los Laboratorios de Referencia Nacional y Departamental en el ámbito de su jurisdicción.
                </br>
                Resolución Administrativa N° 014/2013 de fecha 17 de diciembre de 2013, se reconoce Oficialmente el
                "Programa de Evaluación Externa de la Calidad en Hematología y Química Sanguínea (PEEC)", del
                Laboratorios
                de Análisis
                Clínico dependiente del Instituto Nacional de Laboratorios de Salud. </br>
                Resolución Administrativa Nº 08-A de fecha 16 de abril de 2015, crea el Programa de Evaluación Externa
                de la
                Calidad,
                ...
                "Convocatoria
                Gestión {{ $gestion }} - Programa de Evaluación Externa de la Calidad INLASA" y Anexo 1 - "Oferta
                de
                Servicios".
            </p>
        </div>
        ...
        <div class="section">
            ...
            <p class="clause">
                El presente contrato tiene por objeto establecer las condiciones para la prestación de SERVICIOS
                PRESTADOS
                POR EL
                INLASA PARA LA EVALUACIÓN EXTERNA DE LA CALIDAD y lograr mayor efectividad en las acciones realizadas
                para
                el
        ...
        <div class="section">
            ...
            <p class="clause">
                ...
                b) Recibir y evaluar los resultados enviados por el PARTICIPANTE proporcionando Informes de Evaluación
                en
                ...
                d) Proporcionar al PARTICIPANTE, cuando lo solicite, asesoramiento técnico sobre los programas en los
                que
                está inscrito. </br>
                ...
                g) Poner a disposición del PARTICIPANTE instrucciones relevantes al Programa y actividades a
                desarrollarse
                durante la prestación del servicio. </br>
                h) Informar con la debida antelación, de cambios en la estructura que puedan incidir en el flujo de
                trabajo
                previamente establecido como formato de formularios de resultados, informe de evaluación, Cronograma u
                otros
                que
                pudieran influir en el servicio. </br>
                i) Informar al laboratorio participante cuando se subcontrata el suministro de la muestra de control
                </br>
            </p>
        </div>
        ...
        <div class="section">
            ...
            <p class="clause">
                ...
                b) Seguir las instrucciones proporcionadas por el PEEC - INLASA para realizar correctamente el análisis
                de
                ...
                d) Participar de las reuniones de retroalimentación y responder a encuestas de satisfacción realizadas
                por
                el PEEC - INLASA para mejorar el Programa. </br>
                e) Apelar los resultados de su evaluación, cuando lo considere necesario. </br>
                f) Mantener actualizados sus registros de métodos y equipos, informando al PEEC - INLASA cualquier
                cambio en
                los mismos. </br>
        ...
        <div class="section">
            ...
            <p class="clause">
                ...
                este periodo,
                cualquier
                inscripción, acción o acuerdo relacionado con los términos del presente contrato será considerada válida
                y
                estará
        ...
        <div class="section">
            ...
            <p class="clause">
                ...
                b) Incumplimiento en el envío de muestras establecido en el cronograma de actividades por parte de
                INLASA.
            ...
            <p style="text-align: justify;">
                ...
                La Primera notificación de intención de resolución del contrato, deberá ser cursada en un plazo de cinco
                (5)
                días hábiles
                ...
                conclusión en el
                plazo de diez (10) días hábiles, se debe cursar una segunda carta comunicando que la resolución se ha
                hecho
                efectiva.
            </p>
            <p style="text-align: justify;">
        ...
        <div class="section">
            ...
            <p class="clause">
                El INLASA se compromete mantener la confidencialidad y seguridad de los datos propios del PARTICIPANTE.
                Todo
                el
                ...
                El PARTICIPANTE asume la responsabilidad de protección de datos y confidencialidad de la información de
                su
                cuenta
        ...
        <div class="section">
            ...
            <p class="clause">
                ...
                presente
                contrato y
                que no puedan ser solucionadas por la vía de la concertación, las partes están facultadas para acudir a
                la
                vía judicial o
