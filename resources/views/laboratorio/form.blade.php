        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-2 lg:col-span-3">
                ...
                <input type="text" name="nombre_lab" id="nombre_lab" maxlength="100"
                    ...
                    class="input-standard w-full @error('nombre_lab') border-red-500 @enderror" required>
                @error('nombre_lab')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="respo_lab" id="respo_lab" maxlength="50"
                    ...
                    class="input-standard max-w-md w-full @error('respo_lab') border-red-500 @enderror" required>
                @error('respo_lab')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="repreleg_lab" id="repreleg_lab" maxlength="50"
                    ...
                    class="input-standard max-w-md w-full @error('repreleg_lab') border-red-500 @enderror" required>
                @error('repreleg_lab')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="zona_lab" id="zona_lab" maxlength="50"
                    ...
                    class="input-standard max-w-md w-full @error('zona_lab') border-red-500 @enderror" required>
                @error('zona_lab')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" name="direccion_lab" id="direccion_lab" maxlength="150"
                    ...
                    class="input-standard max-w-md w-full @error('direccion_lab') border-red-500 @enderror" required>
                @error('direccion_lab')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
    ...
    <fieldset class="border p-4 mb-8 rounded-md max-w-3xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="telefone" name="telefono" id="telefono" maxlength="50"
    ...
    <script>
        ...
        async function cargarDepartamentos() {
            const paisId = document.getElementById('id_pais').value;
            ...
            try {
                ...
                departamentos.forEach(dep => {
                    options += `<option value="${dep.id}">${dep.nombre_dep}</option>`;
                });
        ...
        async function cargarProvincias() {
            const depId = document.getElementById('id_dep').value;
            ...
            try {
                ...
                provincias.forEach(prov => {
                    options += `<option value="${prov.id}">${prov.nombre_prov}</option>`;
                });
        ...
        async function cargarMunicipios() {
            const provId = document.getElementById('id_prov').value;
            ...
            try {
                ...
                municipios.forEach(mun => {
                    options += `<option value="${mun.id}">${mun.nombre_municipio}</option>`;
                });
