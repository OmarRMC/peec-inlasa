<x-app-layout>
    <div class="container py-6 max-w-4xl">
        <div class="flex justify-between items-center flex-wrap gap-4 mb-6">
            <h1 class="text-xl font-bold text-primary">Lista de Municipios</h1>
            <a href="{{ route('municipio.create') }}" class="btn-primary">
        ...
        <div class="overflow-x-auto bg-white rounded-lg shadow">
            <table class="table">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex space-x-1">
                                    <a href="{{ route('municipio.edit', $mun->id) }}" data-tippy-content="Editar"
                                        class="bg-blue-100 hover:bg-blue-200 text-blue-700 px-2 py-1 rounded shadow-sm">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form method="POST" action="{{ route('municipio.destroy', $mun->id) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center text-muted py-4">No hay municipios registrados.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
