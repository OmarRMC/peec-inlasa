...
return [
    ...
    | modificarlas según las necesidades de tu aplicación.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes definir nombres personalizados para los atributos en los
    | mensajes de validación, de manera que sean más legibles.
    |
    */
